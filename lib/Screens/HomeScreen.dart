...
class _HomeScreenState extends State<HomeScreen> {
  ...
  var favoriteArray=List.empty(growable: true);
  ...
  void init() async {
    ...
    for (var i = 0; i < articleMap.length; i++) {
      ...
      favoriteArray.add(await ArticleSql().getFavorite(articleMap[i].toString()));
    }
    print(favoriteArray);
                  ...
                  children: [
                    Row(
                      children: [
                          ...
                          child: PopupMenuButton(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [Obx(() => Text(newTag.value)), Icon(Icons.arrow_drop_down)],
                                ),
                              ),
                            ),
                          ),
                        ...
                        Expanded(
                          child: TextField(controller: subTypeController,decoration: InputDecoration(
                              hintText: "子分類"
                          ),),
                        ),
                      ],
                    ...
                    TextField(controller: contextController,decoration: InputDecoration(
                        hintText: "內文"
                    ),),
                    TextField(controller: linkTextController,decoration: InputDecoration(
                        hintText: "連結文字"
                    ),),
                    TextField(controller: linkController,decoration: InputDecoration(
                        hintText: "連結"
                    ),),
                      ...
                      children: [
                        ElevatedButton(onPressed: ()async{
                          ...
                          setState(() async{
                            ...
                            jsonMap["發文日期"]="${now.month.toString().padLeft(2,'0')}/${now.day.toString().padLeft(2,'0')}/${now.year.toString()}";
